...
/* Quotes section */
.wl-quotes-section{{padding:0 12px 36px}}
.inv-portrait-card{{background:linear-gradient(160deg,rgba(30,19,8,.85),rgba(16,10,4,.95));border:1px solid rgba(78,48,16,.4);border-radius:18px;margin-bottom:11px;overflow:hidden;transition:border-color .22s,transform .2s;box-shadow:0 4px 20px rgba(0,0,0,.35)}}
.inv-portrait-card:hover{{border-color:rgba(130,80,22,.7);transform:translateY(-1px)}}
.inv-portrait-top{{display:flex;gap:0;align-items:stretch}}
.inv-portrait-svg{{flex-shrink:0;width:110px;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,rgba(20,13,5,.9),rgba(30,19,8,.8));border-right:1px solid rgba(78,48,16,.3);padding:16px 10px}}
.inv-portrait-svg svg{{width:88px;height:88px}}
.inv-portrait-info{{flex:1;min-width:0;padding:14px 15px 12px}}
.inv-portrait-name{{font-size:1.15rem;font-weight:600;color:var(--g3);letter-spacing:.05em;margin-bottom:1px}}
.inv-portrait-era{{font-family:'Share Tech Mono',monospace;font-size:.52rem;color:var(--dim);letter-spacing:.1em;margin-bottom:8px}}
.inv-portrait-known{{font-size:.82rem;color:var(--sub);line-height:1.65;font-style:italic;margin-bottom:8px}}
.inv-portrait-tag{{display:inline-block;background:rgba(110,69,20,.2);border:1px solid rgba(110,69,20,.4);border-radius:20px;padding:2px 9px;font-family:'Share Tech Mono',monospace;font-size:.5rem;color:var(--g2);letter-spacing:.08em}}
.inv-portrait-quote{{padding:11px 15px 13px;border-top:1px solid rgba(78,48,16,.25);font-size:.82rem;color:rgba(204,160,84,.7);font-style:italic;line-height:1.65}}
.inv-portrait-quote::before{{content:'❝ ';color:rgba(110,69,20,.5);font-size:.9rem}}
...
const DEFAULT_INDEXES = [
  ...
  {{ticker:'VOO', name:'Vanguard S&P 500', color:'gold'}},
  {{ticker:'VTI', name:'Total Market',     color:'muted'}},
...
const INVESTORS = [
  {{
    ...
    era:  "1894 – 1976",
    tag:  "Father of Value Investing",
    known: "Created the intellectual framework for value investing. Author of Security Analysis and The Intelligent Investor. Mentor to Warren Buffett. Invented margin of safety.",
    quote: "The investor's chief problem — and even his worst enemy — is likely to be himself.",
    svg: `<svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
      <circle cx="44" cy="44" r="43" fill="none" stroke="rgba(110,69,20,.35)" stroke-width="1"/>
      <!-- Head -->
      <ellipse cx="44" cy="32" rx="17" ry="20" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Ear left -->
      <path d="M27 30 Q23 33 27 38" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Ear right -->
      <path d="M61 30 Q65 33 61 38" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Eyes -->
      <ellipse cx="37" cy="29" rx="3" ry="2.2" fill="none" stroke="#c8903c" stroke-width="1"/>
      <ellipse cx="51" cy="29" rx="3" ry="2.2" fill="none" stroke="#c8903c" stroke-width="1"/>
      <circle cx="37.5" cy="29" r="1.2" fill="#c8903c"/>
      <circle cx="51.5" cy="29" r="1.2" fill="#c8903c"/>
      <!-- Glasses -->
      <rect x="33" y="27" width="8" height="5" rx="2" fill="none" stroke="#8a5a14" stroke-width=".9"/>
      <rect x="47" y="27" width="8" height="5" rx="2" fill="none" stroke="#8a5a14" stroke-width=".9"/>
      <line x1="41" y1="29.5" x2="47" y2="29.5" stroke="#8a5a14" stroke-width=".9"/>
      <!-- Nose -->
      <path d="M42 33 L40 40 L44 41 L48 40 L46 33" fill="none" stroke="#9a7040" stroke-width=".9"/>
      <!-- Mouth — slight smile -->
      <path d="M38 44 Q44 48 50 44" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Hair — receding -->
      <path d="M27 25 Q30 14 44 12 Q58 14 61 25" fill="none" stroke="#8a6030" stroke-width="1.1"/>
      <path d="M27 25 Q28 22 30 20" fill="none" stroke="#8a6030" stroke-width=".8"/>
      <!-- Suit collar -->
      <path d="M27 52 L35 48 L44 54 L53 48 L61 52 L66 70 L22 70 Z" fill="none" stroke="#7a5828" stroke-width="1.1"/>
      <!-- Tie -->
      <path d="M44 54 L41 62 L44 70 L47 62 Z" fill="none" stroke="#6a4010" stroke-width=".9"/>
      <!-- Neck -->
      <line x1="40" y1="52" x2="38" y2="56" stroke="#b88a4c" stroke-width="1"/>
      <line x1="48" y1="52" x2="50" y2="56" stroke="#b88a4c" stroke-width="1"/>
      <!-- Sketch texture lines -->
      <line x1="22" y1="70" x2="66" y2="70" stroke="rgba(110,69,20,.2)" stroke-width=".5"/>
    </svg>`
  }},
  {{
    name: "Warren Buffett",
    era:  "1930 – present",
    tag:  "Oracle of Omaha",
    known: "Greatest investor of all time. Built Berkshire Hathaway into a $900B empire through patient, fundamentals-driven investing. Coined 'be fearful when others are greedy.'",
    quote: "It's far better to buy a wonderful company at a fair price than a fair company at a wonderful price.",
    svg: `<svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
      <circle cx="44" cy="44" r="43" fill="none" stroke="rgba(110,69,20,.35)" stroke-width="1"/>
      <!-- Head — rounder, older -->
      <ellipse cx="44" cy="33" rx="18" ry="19" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Ears -->
      <path d="M26 30 Q22 34 26 39" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <path d="M62 30 Q66 34 62 39" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Eyes — slightly droopy -->
      <path d="M34 29 Q37 27 40 29 Q37 32 34 29Z" fill="none" stroke="#c8903c" stroke-width="1"/>
      <path d="M48 29 Q51 27 54 29 Q51 32 48 29Z" fill="none" stroke="#c8903c" stroke-width="1"/>
      <circle cx="37" cy="29.5" r="1.3" fill="#c8903c"/>
      <circle cx="51" cy="29.5" r="1.3" fill="#c8903c"/>
      <!-- Glasses — round large -->
      <circle cx="37" cy="30" r="5" fill="none" stroke="#7a5010" stroke-width="1"/>
      <circle cx="51" cy="30" r="5" fill="none" stroke="#7a5010" stroke-width="1"/>
      <line x1="42" y1="30" x2="46" y2="30" stroke="#7a5010" stroke-width="1"/>
      <line x1="26" y1="29" x2="32" y2="29.5" stroke="#7a5010" stroke-width=".8"/>
      <line x1="56" y1="29.5" x2="62" y2="29" stroke="#7a5010" stroke-width=".8"/>
      <!-- Nose — wide -->
      <path d="M43 33 L41 40 L44 42 L47 40 L45 33" fill="none" stroke="#9a7040" stroke-width=".9"/>
      <!-- Big smile -->
      <path d="M36 45 Q44 52 52 45" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Laugh lines -->
      <path d="M35 44 Q33 47 35 50" fill="none" stroke="rgba(160,100,40,.4)" stroke-width=".7"/>
      <path d="M53 44 Q55 47 53 50" fill="none" stroke="rgba(160,100,40,.4)" stroke-width=".7"/>
      <!-- Hair — sparse, swept -->
      <path d="M26 26 Q30 14 44 13 Q58 14 62 26" fill="none" stroke="#888" stroke-width=".8"/>
      <!-- Forehead wrinkles -->
      <path d="M32 22 Q44 20 56 22" fill="none" stroke="rgba(160,100,40,.25)" stroke-width=".6"/>
      <!-- Suit -->
      <path d="M26 52 L36 47 L44 54 L52 47 L62 52 L68 72 L20 72 Z" fill="none" stroke="#7a5828" stroke-width="1.1"/>
      <!-- Tie — polka dot hint -->
      <path d="M44 54 L41 63 L44 72 L47 63 Z" fill="none" stroke="#5a3810" stroke-width=".9"/>
      <circle cx="44" cy="57" r=".9" fill="rgba(110,69,20,.4)"/>
      <circle cx="43" cy="61" r=".9" fill="rgba(110,69,20,.4)"/>
    </svg>`
  }},
  {{
    name: "Peter Lynch",
    era:  "1944 – present",
    tag:  "The People's Investor",
    known: "Ran Fidelity's Magellan Fund to 29% annual returns 1977–90. Champion of 'invest in what you know.' Developed the PEG ratio. Made Wall Street accessible to everyday people.",
    quote: "Know what you own, and know why you own it.",
    svg: `<svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
      <circle cx="44" cy="44" r="43" fill="none" stroke="rgba(110,69,20,.35)" stroke-width="1"/>
      <!-- Head -->
      <ellipse cx="44" cy="31" rx="16" ry="19" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Ears -->
      <path d="M28 29 Q24 33 28 37" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <path d="M60 29 Q64 33 60 37" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Eyes — friendly, wide -->
      <ellipse cx="37" cy="28" rx="3.5" ry="2.8" fill="none" stroke="#c8903c" stroke-width="1"/>
      <ellipse cx="51" cy="28" rx="3.5" ry="2.8" fill="none" stroke="#c8903c" stroke-width="1"/>
      <circle cx="37.5" cy="28" r="1.4" fill="#c8903c"/>
      <circle cx="51.5" cy="28" r="1.4" fill="#c8903c"/>
      <!-- Eyebrows — raised, expressive -->
      <path d="M33 24 Q37 22 41 24" fill="none" stroke="#9a7040" stroke-width="1"/>
      <path d="M47 24 Q51 22 55 24" fill="none" stroke="#9a7040" stroke-width="1"/>
      <!-- Nose -->
      <path d="M43 32 L41 39 L44 40 L47 39 L45 32" fill="none" stroke="#9a7040" stroke-width=".9"/>
      <!-- Warm grin -->
      <path d="M37 43 Q44 49 51 43" fill="none" stroke="#b88a4c" stroke-width="1.2"/>
      <path d="M37 43 Q37 46 39 46" fill="none" stroke="#b88a4c" stroke-width=".8"/>
      <path d="M51 43 Q51 46 49 46" fill="none" stroke="#b88a4c" stroke-width=".8"/>
      <!-- Hair — full, textured -->
      <path d="M28 24 Q30 10 44 9 Q58 10 60 24" fill="none" stroke="#7a6040" stroke-width="1.1"/>
      <path d="M28 24 Q29 18 31 16" fill="none" stroke="#7a6040" stroke-width=".8"/>
      <path d="M60 24 Q59 18 57 16" fill="none" stroke="#7a6040" stroke-width=".8"/>
      <!-- Suit -->
      <path d="M28 50 L37 46 L44 53 L51 46 L60 50 L65 70 L23 70 Z" fill="none" stroke="#7a5828" stroke-width="1.1"/>
      <!-- Tie -->
      <path d="M44 53 L41.5 61 L44 70 L46.5 61 Z" fill="none" stroke="#5a3810" stroke-width=".9"/>
    </svg>`
  }},
  {{
    name: "John Templeton",
    era:  "1912 – 2008",
    tag:  "Pioneer of Global Investing",
    known: "Bought 100 shares of every NYSE stock under $1 in 1939 and made a fortune. Built the first truly global mutual fund. Knighted for services to philanthropy. Coined 'time of maximum pessimism.'",
    quote: "The time of maximum pessimism is the best time to buy.",
    svg: `<svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
      <circle cx="44" cy="44" r="43" fill="none" stroke="rgba(110,69,20,.35)" stroke-width="1"/>
      <!-- Head — distinguished, older -->
      <ellipse cx="44" cy="32" rx="16" ry="18" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Ears -->
      <path d="M28 29 Q24 33 28 38" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <path d="M60 29 Q64 33 60 38" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Eyes — wise, steady -->
      <ellipse cx="37" cy="29" rx="3" ry="2" fill="none" stroke="#c8903c" stroke-width="1"/>
      <ellipse cx="51" cy="29" rx="3" ry="2" fill="none" stroke="#c8903c" stroke-width="1"/>
      <circle cx="37" cy="29" r="1.1" fill="#c8903c"/>
      <circle cx="51" cy="29" r="1.1" fill="#c8903c"/>
      <!-- Glasses — thin wire -->
      <ellipse cx="37" cy="29" rx="5" ry="3.5" fill="none" stroke="#8a6020" stroke-width=".8"/>
      <ellipse cx="51" cy="29" rx="5" ry="3.5" fill="none" stroke="#8a6020" stroke-width=".8"/>
      <line x1="42" y1="29" x2="46" y2="29" stroke="#8a6020" stroke-width=".8"/>
      <!-- Nose — prominent -->
      <path d="M44 33 L41 40 L44 42 L47 40 L44 33" fill="none" stroke="#9a7040" stroke-width="1"/>
      <!-- Composed smile -->
      <path d="M38 45 Q44 49 50 45" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Hair — silver, parted neatly -->
      <path d="M28 24 Q32 12 44 11 Q56 12 60 24" fill="none" stroke="#aaa" stroke-width=".9"/>
      <line x1="44" y1="11" x2="44" y2="20" stroke="#999" stroke-width=".7"/>
      <!-- Age lines -->
      <path d="M30 22 Q32 20 34 22" fill="none" stroke="rgba(160,100,40,.2)" stroke-width=".6"/>
      <!-- Formal suit with pocket square -->
      <path d="M28 51 L37 46 L44 53 L51 46 L60 51 L65 72 L23 72 Z" fill="none" stroke="#7a5828" stroke-width="1.1"/>
      <path d="M37 50 L35 56" fill="none" stroke="#6a4818" stroke-width=".8"/>
      <!-- Bow tie -->
      <path d="M40 53 L44 56 L48 53 L44 50 Z" fill="none" stroke="#5a3810" stroke-width=".9"/>
    </svg>`
  }},
  {{
    name: "George Soros",
    era:  "1930 – present",
    tag:  "The Man Who Broke the Bank",
    known: "Shorted the British pound in 1992 and made $1 billion in a day. Founded reflexivity theory — that market prices influence fundamentals, not just reflect them.",
    quote: "Markets are constantly in a state of uncertainty and flux, and money is made by discounting the obvious.",
    svg: `<svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
      <circle cx="44" cy="44" r="43" fill="none" stroke="rgba(110,69,20,.35)" stroke-width="1"/>
      <!-- Head — angular, strong -->
      <path d="M28 50 Q27 35 30 23 Q37 12 44 12 Q51 12 58 23 Q61 35 60 50" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Ears -->
      <path d="M28 30 Q24 34 28 39" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <path d="M60 30 Q64 34 60 39" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Eyes — intense, hooded -->
      <path d="M33 29 Q37 26 41 29" fill="none" stroke="#9a7040" stroke-width="1.1"/>
      <path d="M47 29 Q51 26 55 29" fill="none" stroke="#9a7040" stroke-width="1.1"/>
      <ellipse cx="37" cy="30" rx="3" ry="2" fill="none" stroke="#c8903c" stroke-width="1"/>
      <ellipse cx="51" cy="30" rx="3" ry="2" fill="none" stroke="#c8903c" stroke-width="1"/>
      <circle cx="37" cy="30" r="1.3" fill="#c8903c"/>
      <circle cx="51" cy="30" r="1.3" fill="#c8903c"/>
      <!-- Heavy brow -->
      <path d="M31 26 Q37 23 41 25" fill="none" stroke="#7a5820" stroke-width="1.4"/>
      <path d="M47 25 Q51 23 57 26" fill="none" stroke="#7a5820" stroke-width="1.4"/>
      <!-- Nose — strong -->
      <path d="M44 34 L42 41 L44 43 L46 41 L44 34" fill="none" stroke="#9a7040" stroke-width="1"/>
      <!-- Slight knowing smile -->
      <path d="M38 46 Q44 50 50 46" fill="none" stroke="#b88a4c" stroke-width="1.1"/>
      <!-- Chin — strong -->
      <path d="M36 49 Q44 54 52 49" fill="none" stroke="#9a7040" stroke-width=".8"/>
      <!-- Silver hair -->
      <path d="M28 24 Q31 11 44 10 Q57 11 60 24" fill="none" stroke="#bbb" stroke-width=".9"/>
      <!-- Suit -->
      <path d="M28 52 L37 47 L44 54 L51 47 L60 52 L66 72 L22 72 Z" fill="none" stroke="#7a5828" stroke-width="1.1"/>
      <!-- Tie -->
      <path d="M44 54 L41 63 L44 72 L47 63 Z" fill="none" stroke="#5a3810" stroke-width=".9"/>
    </svg>`
  }},
  {{
    name: "Charlie Munger",
    era:  "1924 – 2023",
    tag:  "The Architect of Berkshire",
    known: "Buffett's partner and intellectual equal. Developed the concept of mental models and latticeworks of knowledge for decision-making. Championed buying quality over cheap mediocrity.",
    quote: "Invert, always invert. Many problems are best solved by considering what you want to avoid.",
    svg: `<svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
      <circle cx="44" cy="44" r="43" fill="none" stroke="rgba(110,69,20,.35)" stroke-width="1"/>
      <!-- Head — strong jaw, distinctive -->
      <path d="M28 48 Q27 34 31 22 Q37 12 44 12 Q51 12 57 22 Q61 34 60 48 Q56 56 44 57 Q32 56 28 48Z" fill="none" stroke="#b88a4c" stroke-width="1.3"/>
      <!-- Ears — large -->
      <path d="M28 30 Q22 35 27 42" fill="none" stroke="#b88a4c" stroke-width="1.2"/>
      <path d="M60 30 Q66 35 61 42" fill="none" stroke="#b88a4c" stroke-width="1.2"/>
      <!-- Eyes — one partially closed (blind in one eye) -->
      <ellipse cx="37" cy="29" rx="3.2" ry="1.8" fill="none" stroke="#c8903c" stroke-width="1"/>
      <path d="M48 30 Q51 26 54 30" fill="none" stroke="#9a7040" stroke-width="1"/>
      <circle cx="37" cy="29" r="1.2" fill="#c8903c"/>
      <!-- Thick glasses -->
      <rect x="32.5" y="26" width="9" height="7" rx="2.5" fill="none" stroke="#6a4810" stroke-width="1.1"/>
      <rect x="46.5" y="26" width="9" height="7" rx="2.5" fill="none" stroke="#6a4810" stroke-width="1.1"/>
      <line x1="41.5" y1="29.5" x2="46.5" y2="29.5" stroke="#6a4810" stroke-width="1.1"/>
      <line x1="26" y1="28.5" x2="32.5" y2="28.5" stroke="#6a4810" stroke-width=".9"/>
      <line x1="55.5" y1="28.5" x2="62" y2="28.5" stroke="#6a4810" stroke-width=".9"/>
      <!-- Nose — broad -->
      <path d="M44 34 L41 41 L44 43 L47 41 L44 34" fill="none" stroke="#9a7040" stroke-width="1"/>
      <!-- Wry thin-lipped smile -->
      <path d="M38 46 Q44 49 50 46" fill="none" stroke="#b88a4c" stroke-width="1"/>
      <path d="M38 46 L36 47" fill="none" stroke="#b88a4c" stroke-width=".8"/>
      <!-- Hair — white, wispy -->
      <path d="M28 22 Q32 10 44 9 Q56 10 60 22" fill="none" stroke="#ccc" stroke-width=".8"/>
      <!-- Suit -->
      <path d="M28 52 L37 47 L44 54 L51 47 L60 52 L66 72 L22 72 Z" fill="none" stroke="#7a5828" stroke-width="1.1"/>
      <path d="M44 54 L41.5 62 L44 72 L46.5 62 Z" fill="none" stroke="#5a3810" stroke-width=".9"/>
    </svg>`
  }},
];

function buildPortraitsSection() {{
  return `<div class="wl-quotes-section">
    <div class="wl-section-label" style="padding:22px 0 10px">◈ &nbsp;MASTERS OF THE MARKET</div>
    ${{INVESTORS.map(inv => `
      <div class="inv-portrait-card">
        <div class="inv-portrait-top">
          <div class="inv-portrait-svg">${{inv.svg}}</div>
          <div class="inv-portrait-info">
            <div class="inv-portrait-name">${{inv.name}}</div>
            <div class="inv-portrait-era">${{inv.era}}</div>
            <div class="inv-portrait-known">${{inv.known}}</div>
            <span class="inv-portrait-tag">${{inv.tag}}</span>
          </div>
        </div>
        <div class="inv-portrait-quote">${{inv.quote}}</div>
      </div>`).join('')}}
  </div>`;
}}
...
function renderWLPage() {{
  ...
  if (count === 0) {{
    ...
    // Quotes below
    let qEl = document.getElementById('wl-quotes-wrap');
    if (!qEl) {{
      qEl = document.createElement('div'); qEl.id = 'wl-quotes-wrap';
      document.querySelector('.wl-page').appendChild(qEl);
    }}
    qEl.innerHTML = buildPortraitsSection();
  }} else {{
