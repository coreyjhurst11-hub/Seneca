...
function render(d){{
  ...
  // ── LEADERSHIP / GOVERNANCE (lazy) ──
  html+=`<div id="lead-mount"><div class="lead-block"><div class="lead-head"><div class="lead-title"><div class="lead-ic">⊟</div>COMMAND STRUCTURE</div></div><div class="ai-loading"><div class="dot"></div><div class="dot"></div><div class="dot"></div><span class="ai-loading-txt">Mapping the org chart…</span></div></div></div>`;
