...
def get_health_ai(data):
    ...
    try:
        ...
        msg=c.messages.create(model="claude-sonnet-4-20250514",max_tokens=250,messages=[{"role":"user","content":p}])
        return msg.content[0].text.strip()
    except: return None
  ...
  try {{
    ...
    if(r.ok) {{
      ...
      el.innerHTML=d.analysis
        ...
        :'<span style="color:var(--dim);font-size:.7rem;font-style:italic">Add ANTHROPIC_API_KEY in Railway to enable AI forensics</span>';
    }}
