...
.intro-cta{{width:100%;height:52px;background:linear-gradient(135deg,var(--gold),var(--gold3));border:none;border-radius:13px;font-family:var(--mono);font-size:.68rem;font-weight:700;color:#000;letter-spacing:.14em;cursor:pointer;margin-bottom:12px;transition:opacity .15s,transform .15s}}
